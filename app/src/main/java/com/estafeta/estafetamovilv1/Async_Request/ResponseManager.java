 ...
 * This class handles the change information received from XML to HashMaps.
 */
public class ResponseManager {
    ...
    /**
     * Get the information of postal codes in XML and converted to a Map.
     * @param doc
     * @param tipo
     * @return
     * @throws SAXException
    ...
    /**
     * Get the information of Guides in XML and converted to a Map.
     * @param doc
     * @return
     * @throws SAXException
     * @throws IOException
    ...
    /**
     * Get the information of offices in XML and converted to a Map.
     * @param doc
     * @return
     * @throws SAXException
     * @throws IOException
    ...
    /**
     * Get the information of quotations in XML and converted to a Map.
     * @param doc
     * @return
     * @throws SAXException
     * @throws IOException
    ...
    /**
     * Get the information of international_quotation in XML and converted to a Map.
     * @param doc
     * @return
     * @throws SAXException
     * @throws IOException
...
*/
    ...
    /**
     * Get the information of exception_codes in XML and converted to a Map.
     * @param doc
     * @return
     * @throws SAXException
     * @throws IOException

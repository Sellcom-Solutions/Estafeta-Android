...
import com.estafeta.estafetamovilv1.Fragments.FragmentDetalleRastreo;
 ...
 * This adapter is for FragmentRastreoEfectuado class.
 */
public class RastreoEfectuadoAdapter extends BaseAdapter{
    ...
    Activity activity;
    /**
     * Variable that will store the new status once known.
     */
    String new_status;

    /**
     * List of codes scanned caught with their properties, comes from the server.
     */
     ...
     * Saves scans favorites and determines the status of each track.
     *
     */
    @Override
     ...
     *
     * @param status Status variable that comes from the server.
     * @param code Exception code, variable that comes from the server.
     * @return Returns the kind of status that has the scan code.
     */

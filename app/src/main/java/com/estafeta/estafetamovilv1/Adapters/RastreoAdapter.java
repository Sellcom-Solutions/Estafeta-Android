 ...
 * This class is deprecated, it served to remove an item from the scan list with Swipe effect.
 * @deprecated This class is deprecated, it served to remove an item from the scan list with Swipe effect.
 */
...
public class RastreoAdapter extends BaseSwipeAdapter {
    ...
    /**
     * This method assigns the operation to make the Swipe button.
     */
    @Override

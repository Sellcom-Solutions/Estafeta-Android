 ...
 * This adapter is for FragmentHistory class.
 */
public class HistoryAdapter extends BaseAdapter {
    Context context;
    /**
     * List containing the story of a tracking code.
     */
     ...
     * Here the list is generated with information of history.
     */
    @Override
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            String placeStr = item.get("H_eventPlaceName") + " - " + item.get("H_eventDescriptionSPA");
            holder.place.setText(placeStr);
            String commentStr = item.get("H_exceptionCodeDescriptionSPA");

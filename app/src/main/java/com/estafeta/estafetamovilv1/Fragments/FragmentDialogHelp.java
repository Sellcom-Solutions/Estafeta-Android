...
/**
 * This class displays images help to scan a code.
 */
public class FragmentDialogHelp extends DialogFragment implements View.OnClickListener {
    ...
    /**
     * This method changes the background color of the selected button.
     * @param button
     */
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        //Este método sirve para forzar a cambiar el layout de orientación cuando la orientación de la pantalla cambia.
